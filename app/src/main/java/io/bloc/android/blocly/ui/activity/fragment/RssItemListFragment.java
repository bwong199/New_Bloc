package io.bloc.android.blocly.ui.activity.fragment;
...
public class RssItemListFragment extends Fragment implements ItemAdapter.DataSource, ItemAdapter.Delegate {
    ...
    public static RssItemListFragment fragmentForRssFeed(RssFeed rssFeed){
        ...
        RssItemListFragment rssItemListGragment = new RssItemListFragment();
    ...
    private SwipeRefreshLayout swiipeRefreshLayout;
    ...
    private WeakReference<Delegate> delegatee;

    @Override
    public void onAttach(Activity activity){
        super.onAttach(activity);

        delegatee = new WeakReference<Delegate>((Delegate) activity);
